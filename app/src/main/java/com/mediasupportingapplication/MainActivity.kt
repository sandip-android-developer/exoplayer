...
class MainActivity : AppCompatActivity() {
    ...
    private fun initView() {
        ...
        btnonClickAVI.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = " https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-avi-file.avi"
        ...
        btnonClickMOV.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-mov-file.mov"
            intent.putExtra("media",media)
        ...
        btnonClickMPG.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-mpg-file.mpg"
        ...
        btnonClickWMV.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-wmv-file.wmv"
        ...
        btnonClickFLV.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-flv-file.flv"
        ...
        btnonClickWEBM.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-webm-file.webm"
        ...
        btnonClickMKV.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-mkv-file.mkv"
        ...
        btnonClickOGV.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-ogv-file.ogv"
        ...
        btnonClick3GP.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-3gp-file.3gp"
        ...
        btnonClick3G2.setOnClickListener {
            var intent = Intent(this, VidepPlayerActivity::class.java)
            media = "https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-3g2-file.3g2"
            intent.putExtra("mediaType","3gp")
            intent.putExtra("media",media)
            startActivity(intent)
        }
